...
public class TileUpdateEvent extends Event
{
	...
	public TileUpdateEvent(TilePos tile)
	{
		this.tile = tile;
	}
	...
	public class Border extends TileUpdateEvent
	{
	...
	public class Owner extends TileUpdateEvent
	{
	...
	public class Structure extends TileUpdateEvent
	{
