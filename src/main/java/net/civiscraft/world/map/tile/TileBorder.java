...
public class TileBorder
{
	...
	private TileBorder (TilePos pos, boolean complete, ArrayList<TreeMap<BlockPos, Integer>> northBorder, ArrayList<TreeMap<BlockPos, Integer>> eastBorder, ArrayList<TreeMap<BlockPos, Integer>> southBorder, ArrayList<TreeMap<BlockPos, Integer>> westBorder, @Nullable World world)
	{
		this.pos = pos;
	...
	public static TileBorder readFromNBT(NBTTagCompound nbt, World world)
	{
		...
		else {return new TileBorder(_pos, _complete, null, null, null, null, world);}
	}
