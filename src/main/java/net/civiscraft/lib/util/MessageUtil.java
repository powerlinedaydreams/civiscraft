...
import net.civiscraft.lib.util.data.DelayedList;
...
public class MessageUtil
{
    ...
    public static void writeBooleanArray(PacketBuffer buf, boolean[] bool) {
        PacketBufferCC bufcc = PacketBufferCC.asPacketBufferCc(buf);
        for (boolean b : bool) {
            bufcc.writeBoolean(b);
        }
    }
    ...
    public static void writeEnumOrNull(ByteBuf buffer, Enum<?> value) {
        PacketBufferCC buf = PacketBufferCC.asPacketBufferCc(buffer);
        if (value == null) {
