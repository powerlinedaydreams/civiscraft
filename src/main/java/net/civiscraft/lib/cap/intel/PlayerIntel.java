...
public class PlayerIntel implements IIntel
{
	...
	public void addWatchedTile(TilePos tile)
	{
		...
		{
			net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new TileWatchEvent.Watch(tile, (EntityPlayerMP) player));
			
			if(!seenTiles.contains(tile))
			{
				net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new TileWatchEvent.Seen(tile, (EntityPlayerMP) player));
			}
		}
	}
	...
	public void addWatchedTiles(ArrayList<TilePos> tiles)
	{
		...
		if(!player.world.isRemote && wTiles.size() > 0)
		{
			if(wTiles.size() == 1)
			{
				net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new TileWatchEvent.Watch(wTiles.get(0), (EntityPlayerMP) player));
			}
			
			else
			{
				net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new TileWatchEvent.Watch(wTiles, (EntityPlayerMP) player));
			}
		}
		...
		if(!player.world.isRemote && sTiles.size() > 0)
		{
			if(sTiles.size() == 1)
			{
				net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new TileWatchEvent.Seen(sTiles.get(0), (EntityPlayerMP) player));
			}
			
			else
			{
				net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new TileWatchEvent.Seen(sTiles, (EntityPlayerMP) player));
			}
		}
	}
	...
	public void removeWatchedTile(TilePos tile)
	{
		...
		{
			net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new TileWatchEvent.UnWatch(tile, (EntityPlayerMP) player));
		}
	}
	...
	public void removeWatchedTiles(ArrayList<TilePos> tiles)
	{
		...
		if(!player.world.isRemote && _tiles.size() > 0)
		{
			if(_tiles.size() == 1)
			{
				net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new TileWatchEvent.UnWatch(_tiles.get(0), (EntityPlayerMP) player));
			}
			
			else
			{
				net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new TileWatchEvent.UnWatch(_tiles, (EntityPlayerMP) player));
			}
		}
	}
