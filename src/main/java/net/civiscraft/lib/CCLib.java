...
import net.civiscraft.lib.command.CiviscraftCommand;
...
@Mod(modid = CCLib.MODID, name = "CivisCraft Lib", version = CCLib.VERSION)
...
public class CCLib
{
	...
	public static void preInit(FMLPreInitializationEvent e)
	{
		...
		CCLog.logger.info("Copyright (c) the CivisCraft team, 2019");
	...
	{
		e.registerServerCommand(new CiviscraftCommand());
	}
}
